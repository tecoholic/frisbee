...
class TestAnalysis:
    """Tests for the analyse_game_string"""
    ...
    def test_for_1player_drop(self):
        ...
        assert_equals( analyse_game_string(gs), res )
